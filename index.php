...
<head>
    ...
    <!-- Favicons -->
    <link href="assets/img/logo_full_size.png" rel="icon">
    <link href="assets/img/logo_full_size.png" rel="apple-touch-icon">
...
<section id="hero">
    <div class="hero-container">
        <h1>UNIKAT KAMEN</h1>
        <h2 class="text-center text-light">POSTAVLJAMO KAMEN PO KAMEN, GRADEĆI NAŠU BUDUĆNOST KALDRMOM ZAJEDNO</h2>

        <br>

        <a href="#about" class="btn-get-started scrollto"> O NAMA<i class="bi bi-chevron-double-down"></i>
        </a>
    </div>
</section><!-- #hero -->
...
<main id="main">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul id="portfolio-flters">
                        <li data-filter="*" class="filter-active">Naše Fotografije <i
    ...
    <!-- ======= Map Section ======= -->
    <section class="map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2827.4321165913148!2d20.671295476706288!3d44.8738544726328!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x475a7f03a7164a45%3A0x7155014852c55201!2z0JHQsNC90LjRmNGB0LrQsCA0OSwg0J_QsNC90YfQtdCy0L4!5e0!3m2!1ssr!2srs!4v1691926072529!5m2!1ssr!2srs"
...
<footer id="footer">
    <div class="container">
        <div class="copyright">
            &copy; Copyright <strong><span>Unikat Kamen</span></strong>. Sva prava zadržana
